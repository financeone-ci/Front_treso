...
function VueAudit(props) {
  ...
  // Variables
  const Api = "audits-connexion/ReadAudit.php";
  ...
  const supprDevise = async (values) => {
    ...
    response = await axios.post(
      `audits-connexion/DeleteAudit.php?id=${values}`,
      { values },
      { headers }
    );
